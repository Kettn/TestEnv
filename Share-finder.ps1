...
function Invoke-ContributionSpotter {
    ...
    Write-Verbose "[*] Running ContributionSpotter on domain $targetDomain with delay of $Delay"
    $servers = @()
...
function Invoke-ContributionSpotterThreaded {
